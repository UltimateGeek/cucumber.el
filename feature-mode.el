...
(defconst feature-docstring-re "^[ \t]*(\"\"\"|```)$"
  "Regexp matching a docstring")
    ...
    (if (bobp) feature-indent-initial-offset
      (let* ((lang (feature-detect-language))
        ...
        (cond
         ...
         ((or (looking-at feature-example-line-re) (looking-at feature-docstring-re))
          (progn
            (feature-search-for-regex-match
            ...
            (cond
             ...
             ((or (looking-at feature-example-line-re)
                  (looking-at feature-docstring-re))
              (current-indentation))
             (t saved-indentation))
            ))
         (t
